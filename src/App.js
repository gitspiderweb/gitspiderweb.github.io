...
function App() {
    ...
    const about = {
        ...
        bio: [
            "Mark Jay Cabatuan, a skilled developer and graphic designer from Basak, Mandaue City, holds a degree in BS Information Technology from UC-LM. He previously worked as a Product Setup Engineer at Northern Lights Technology Development, utilizing his proficiency in Adobe software to create visually appealing stationery products.",
            "However, in September of last year, he made a pivotal career move, resigning from his position to fully dedicate himself to web development. Since August 2023, he has been a Software Developer at ACRET-PH, focusing on web development in Drupal.",
